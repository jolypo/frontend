  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="topTols-delivery" style={{ display: "flex", gap: "10px", position: "relative" }}>
      ...
      {materials.map((mat, index) => (
        ...
        >
          ...
          <div className="itemTols-delivery" style={{ display: "flex", gap: "10px", marginBottom: "10px" }}>
            <div style={{ position: "relative", flex: 1 }}>
              <input
                type="text"
